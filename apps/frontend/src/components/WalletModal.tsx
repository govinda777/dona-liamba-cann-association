        ...
        <div className="pt-14 p-8">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-emerald-50 rounded-2xl p-5 border border-emerald-100">
                  ...
                  <p className="text-2xl font-black text-emerald-900 mt-1">
                    {isLoading
                      ? "..."
                      : parseFloat(formatEther(balance?.value || 0n)).toFixed(
                          4,
                        )}{" "}
                    <span className="text-sm font-bold opacity-60">ETH</span>
                  </p>
                </div>
          ...
          {view === "receive" && (
            <div className="animate-in fade-in slide-in-from-right-2 duration-300 text-center">
              ...
              <p className="text-sm text-slate-500 mb-8">
                Escaneie o código ou copie o endereço
              </p>
              ...
              >
                <div className="text-left overflow-hidden">
                  ...
                  <p className="text-sm font-mono text-slate-700 truncate pr-4">
                    {address}
                  </p>
                </div>
          ...
          {view === "send" && (
            <div className="animate-in fade-in slide-in-from-left-2 duration-300">
              ...
              <p className="text-sm text-slate-500 mb-8">
                Transfira ativos para outra carteira
              </p>
              ...
              <form onSubmit={handleSend} className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-2 flex justify-between">
                    <span>
                      Disponível:{" "}
                      {parseFloat(formatEther(balance?.value || 0n)).toFixed(4)}{" "}
                      ETH
                    </span>
                    <button
                      type="button"
                      onClick={() =>
                        setAmount(formatEther(balance?.value || 0n))
                      }
