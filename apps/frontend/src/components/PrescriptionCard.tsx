      ...
      <CardContent>
        <div className="flex items-center justify-between gap-2 pt-2 border-t border-dashed border-gray-100">
          <Button
            variant="outline"
            size="sm"
            className="flex-1 text-xs h-8 border-primary-200 hover:bg-primary-50 text-primary-700"
          >
            Ver Dados <Lock className="w-3 h-3 ml-1" />
          </Button>
          <Button
            size="sm"
            className="flex-1 text-xs h-8 bg-primary-600 hover:bg-primary-700 shadow-sm disabled:opacity-50"
