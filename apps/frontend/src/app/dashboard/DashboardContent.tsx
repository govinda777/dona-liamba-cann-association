...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-primary-50/30">
      {/* Header Dashboard */}
      <div className="bg-white/95 backdrop-blur-md border-b border-primary-100 sticky top-0 z-40 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 sm:gap-8">
              <Link href="/" className="flex items-center space-x-2 group shrink-0">
                ...
                <span className="text-lg font-bold text-primary-900 tracking-tight font-serif hidden sm:block">
                  Dona Liamba
                </span>
              </Link>
            ...
            <div className="flex items-center gap-3 sm:gap-6">
              <div className="hidden lg:block scale-90 origin-right transition-all hover:scale-95">
                <BalanceCard onClick={() => setIsWalletModalOpen(true)} />
              </div>
